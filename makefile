...
OBJ = $(OBJDIR)/assess.o $(OBJDIR)/frequency.o $(OBJDIR)/blockFrequency.o \
	  ...
	  $(OBJDIR)/pokerDetect.o $(OBJDIR)/runsDistribution.o $(OBJDIR)/binaryDerivate.o $(OBJDIR)/selfCorrelation.o
...
$(OBJDIR)/pokerDetect.o: $(SRCDIR)/pokerDetect.c defs.h externs.h utilities.h stat_fncs.h
	$(CC) -o $@ $(GCCFLAGS) $(SRCDIR)/pokerDetect.c

$(OBJDIR)/runsDistribution.o: $(SRCDIR)/runsDistribution.c defs.h externs.h utilities.h stat_fncs.h
	$(CC) -o $@ $(GCCFLAGS) $(SRCDIR)/runsDistribution.c

$(OBJDIR)/binaryDerivate.o: $(SRCDIR)/binaryDerivate.c defs.h externs.h utilities.h stat_fncs.h
	$(CC) -o $@ $(GCCFLAGS) $(SRCDIR)/binaryDerivate.c

$(OBJDIR)/selfCorrelation.o: $(SRCDIR)/selfCorrelation.c defs.h externs.h utilities.h stat_fncs.h
...
clean:
	rm -f assess $(OBJDIR)/*.o ../randomTestTools/assess.exe
test:
	g++ test.cpp -o test
	test.exe
