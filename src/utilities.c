...
int
generatorOptions(char* filePath, char** streamFile)
{
	// char	file[200];
...
chooseTests()
{
	...
	{
		// 国密算法
		if(i == TEST_NONPERIODIC || i == TEST_OVERLAPPING || i == TEST_RND_EXCURSION || i == TEST_RND_EXCURSION_VAR)
		{
...
openOutputStreams(int option, int bitStreamNum)
{
	...
	tp.numOfBitStreams = bitStreamNum;
	printf("\n");
}
